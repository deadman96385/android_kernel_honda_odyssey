...
/* AIN2 - Lane watch camera
   AIN3 - Rear view camera
   Select the default camera based on product */
#ifdef CONFIG_NTSC_REARCAMERA
#define ADV7180_INPUT_CONTROL_INSEL_DEF 		(ADV7180_INPUT_CONTROL_INSEL_AIN3)
#else
#define ADV7180_INPUT_CONTROL_INSEL_DEF 		(ADV7180_INPUT_CONTROL_INSEL_AIN2)
#endif
