...
#define HCD_FLAG_ENABLE_HUBS_ON_EXT_PORTS	7	/* enable more extended hubs? */
#endif
...
#ifdef CONFIG_USB_DISABLE_HUBS_ON_EXT_PORTS
#define HCD_ENABLE_HUBS_ON_EXT_PORTS(hcd)		((hcd)->flags & (1U << HCD_FLAG_ENABLE_HUBS_ON_EXT_PORTS))
#endif
